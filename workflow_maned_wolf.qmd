...
This document includes the code used to conduct the analyses and is intended to support inspection of the analytical workflow. All files displayed in this annotated code are available for download from the [project repository](https://github.com/anayoko/maned-wolf-mange-movement/). The workflow follows this order:
